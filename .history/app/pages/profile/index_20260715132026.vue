      ...
      <div class="space-y-4 p-4 sm:p-6 lg:p-8">
        ...
        <div class="grid gap-6 xl:grid-cols-2">
          ...
          <section class="rounded-2xl border border-base-300 bg-base-100 p-5">
            ...
            <div v-else-if="activeLineAccount" class="mt-5 rounded-2xl border border-success/25 bg-success/5 p-4">
              <div class="flex items-center gap-3">
                ...
                <div class="min-w-0">
                  <div class="flex flex-wrap items-center gap-2">
                    ...
                    <span class="badge badge-success badge-outline badge-sm">เชื่อมแล้ว</span>
                  </div>
                  <p class="mt-1 text-xs text-base-content/55">
                    LINE ID: {{ maskLineUserId(activeLineAccount.line_user_id) }}
                  </p>
                </div>
              </div>

              <div class="mt-4 flex flex-col gap-2 sm:flex-row">
                <button class="btn btn-outline btn-primary btn-sm flex-1" @click="connectLine">
                  เชื่อมบัญชีอื่น
                </button>
                <button
            ...
            <div v-else class="mt-5 rounded-2xl border border-dashed border-base-300 bg-base-200/40 p-5 text-center">
              <Icon
