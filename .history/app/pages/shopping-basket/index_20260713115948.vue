  ...
  <div class="w-full bg-base-100">
    <div class="mx-auto w-full max-w-[80%] px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      <div class="p-4 sm:p-6 lg:p-8 space-y-4">
        ...
        <div
          v-if="basketRows.length"
          class="mb-5 flex items-center justify-between gap-3 rounded-xl border border-success/30 bg-success/10 px-4 py-3 text-sm text-success-content"
        >
          ...
          <span class="hidden text-xs text-base-content/60 sm:inline"
            >ปรับจำนวนหรือลบรายการได้ด้านล่าง</span
          >
        </div>

        <section
          class="mb-6 rounded-xl border border-base-300 bg-base-200/40 p-4 sm:p-5"
        >
          <div
              ...
              <div>
                ...
                <template v-if="selectedLocation">
                  <p class="text-sm font-semibold">
                    ...
                    {{ selectedLocation.recipient }}
                  </p>
                  <p
                    class="mt-1 max-w-2xl text-sm leading-6 text-base-content/65"
                  >
                  ...
                  <tr v-else-if="!basketRows.length">
                    <td colspan="4" class="py-14 text-center">
                      ...
                      <p class="mt-1 text-sm text-base-content/55">
                        ...
                        แล้วกลับมาดำเนินการสั่งซื้อได้ที่นี่
                      </p>
                    </td>
                  </tr>
                  <tr
                  ...
                  >
                    <td class="border-t border-base-300 px-5 py-4">
                      <div class="flex min-w-90 items-center gap-4">
                        <div
                          class="flex size-20 shrink-0 items-center justify-center rounded-xl border border-base-300 bg-primary/5 text-primary"
                        >
              ...
              >
                ...
                >
                  <Icon
                    ...
                    size="23"
                    :class="
                      option.id === 'express' ? 'text-warning' : 'text-primary'
                    "
                  />
    ...
    <div class="modal-box max-w-2xl p-0">
      ...
      >
        <div>
          ...
          <p class="mt-1 text-sm text-base-content/60">
            ข้อมูลส่วนนี้เป็น mockup และยังไม่บันทึกลงฐานข้อมูล
          </p>
        </div>
        <button
          class="btn btn-circle btn-ghost btn-sm"
          @click="locationModal?.close()"
        >
        ...
        <div class="space-y-3">
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div>
                <p class="font-bold">
                  {{ location.label }}: {{ location.recipient }}
                </p>
          ...
          <form class="mt-4 space-y-3" @submit.prevent="addMockLocation">
            <div class="grid gap-3 sm:grid-cols-2">
              <label class="form-control"
                ><span class="label-text mb-1 text-sm">ชื่อเรียกที่อยู่</span
                ><input
                  v-model.trim="locationForm.label"
                  required
                  class="input input-bordered w-full"
                  placeholder="เช่น บ้าน, ที่ทำงาน"
              /></label>
              <label class="form-control"
                ><span class="label-text mb-1 text-sm">ผู้รับสินค้า</span
                ><input
                  v-model.trim="locationForm.recipient"
                  required
                  class="input input-bordered w-full"
            ...
            <label class="form-control"
              ...
              ><input
                v-model.trim="locationForm.phone"
                required
                class="input input-bordered w-full"
                inputmode="tel"
            ...
            <label class="form-control"
              ...
              ><textarea
                v-model.trim="locationForm.address"
                required
            ...
            <button class="btn btn-primary w-full" type="submit">
              <Icon name="lucide:plus" size="17" /> เพิ่มที่อยู่ (Mockup)
            </button>
          </form>
        </div>
      </div>
...
const locations = ref<Location[]>([
  {
    id: "home",
    label: "บ้าน",
    recipient: "สิรภัทร ลิ้มรังษี",
    phone: "081-234-5678",
    address: "99/99 ถนนตัวอย่าง แขวงคลองตันเหนือ เขตวัฒนา กรุงเทพมหานคร 10110",
  },
  {
    id: "office",
    label: "ที่ทำงาน",
    ...
    phone: "081-234-5678",
    address:
      "อาคารฟินแลนด์ พลาซ่า ชั้น 5 ถนนสุขุมวิท แขวงคลองตัน เขตวัฒนา กรุงเทพมหานคร 10110",
  },
]);
