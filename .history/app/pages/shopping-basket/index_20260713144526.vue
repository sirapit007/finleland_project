<template>
  ...
  <dialog ref="createAddressModal" class="modal">
    <div class="modal-box max-w-3xl p-0">
      ...
      <form class="max-h-[78vh] space-y-4 overflow-y-auto p-5 sm:p-6" @submit.prevent="saveCreateAddress">
  ...
  <dialog ref="editAddressModal" class="modal">
    <div class="modal-box max-w-3xl p-0">
      ...
      <form class="max-h-[78vh] space-y-4 overflow-y-auto p-5 sm:p-6" @submit.prevent="saveEditAddress">
        <div class="grid gap-3 sm:grid-cols-2">
          <label class="form-control">
            <span class="label-text mb-1 text-sm">ชื่อที่อยู่</span>
            <input
