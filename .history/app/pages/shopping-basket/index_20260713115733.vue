<template>
  <div class="w-full bg-base-100">
    <div class="mx-auto w-full max-w-[80%] px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      <div class="rounded-2xl border border-base-300 bg-base-100 p-4 shadow-sm sm:p-6 lg:p-8">
        <div class="mb-6 flex flex-wrap items-center gap-2 text-sm text-base-content/60">
          <NuxtLink to="/" class="hover:text-primary">หน้าแรก</NuxtLink>
        ...
        <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start">
          ...
          <aside class="rounded-xl border border-base-300 bg-base-100 p-5 shadow-sm lg:sticky lg:top-6">
