        ...
        <div class="flex-none">
          ...
          >
            ...
            <div class="border border-base-300">
              ...
              <div><Icon name="lucide:truck" size="16" /> จัดส่งทั่วประเทศ</div>
              <div>โดยขนส่งเอกชน</div>
              <div>เริ่มต้น 35.-</div>
              <div>2 - 4 วันทำการ</div>
            </div>
            <div class="border border-base-300">
              <input type="radio" name="radio-1" class="radio" />
              <div>
                <Icon name="lucide:motorbike" size="16" /> ส่งด่วนใกล้บ้าน
              </div>
              <div>ภายใน 1-2 ชม.</div>
              <div>เริ่มต้น 39.-</div>
              <div>เฉพาะพื้นที่ให้บริการ</div>
            </div>
          </div>
        </div>
      </div>
