                ...
                <tbody>
                  ...
                  >
                        ...
                        <div class="min-w-0">
                          ...
                          >
                            <p class="flex items-center gap-1 font-semibold">
                              <Icon
                                :name="pricingFor(basket).isEligible ? 'lucide:badge-check' : 'lucide:circle-alert'"
                                size="14"
                              />
                              {{
                                pricingFor(basket).isEligible
                          ...
                          <button
                            class="btn btn-ghost btn-xs mt-2 -ml-2 text-base-content/55 hover:text-error flex items-center"
                    ...
                    <td class="border-t border-base-300 px-4 py-4 text-right">
                      ...
                      <p
                        class="font-bold"
                        :class="pricingFor(basket).isEligible ? 'text-error' : 'text-primary'"
                      >
                    ...
                    <td class="border-t border-base-300 px-5 py-4 text-right">
                      ...
                      <p
                        ...
                        :class="pricingFor(basket).discount > 0 ? 'text-error' : 'text-primary'"
                      >
          ...
          >
            ...
            <div class="mt-5 space-y-3 text-sm">
              ...
              <div class="flex justify-between gap-4 text-success">
                ...
                <span class="font-semibold">-฿{{ formatPrice(totalDiscount) }}</span>
              </div>
              <div class="flex justify-between gap-4 text-base-content/70">
                <span>ค่าจัดส่ง</span>
                <span class="font-semibold text-base-content"
...
const pricingFor = (basket: any): BasketPromotionPricing => {
  ...
  const storedUnitPrice = quantity
    ...
    : 0;
  const normalUnitPrice = Number(basket.product_selling_price || storedUnitPrice);
  ...
  const minPurchaseAmount = Number(
    basket.promotion_min_purchase_amount || 0,
  );
  const hasPromotion =
