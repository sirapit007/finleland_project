...
<div class="space-y-3">
  <label class="block cursor-pointer">
    ...
    <div
      class="flex items-start gap-3 rounded-lg border border-base-300 p-4 transition-all
    ...
    >
      <div class="mt-1">
        <div
          class="flex h-5 w-5 items-center justify-center rounded-full border-2 border-base-300
                 peer-checked:border-primary"
        >
          <div
            class="h-2.5 w-2.5 rounded-full bg-primary opacity-0 transition
