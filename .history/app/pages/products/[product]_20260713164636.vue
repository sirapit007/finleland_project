<template>
  ...
  <div
    class="w-full flex flex-col justify-center items-center pt-5 border border-b border-base-content/10 mx-auto w-full max-w-7xl px-0 py-6 sm:px-6 sm:py-8 lg:px-8"
  >
