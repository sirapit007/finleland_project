<template>
  ...
  >
    <div class="store-page__container text-xl text-start font-semibold">
      หมวดหมู่ที่เกี่ยวข้อง
    </div>

    <div class="store-page__container relative overflow-hidden">
  ...
  <div
    class="w-full flex flex-col justify-center items-center pt-5 border border-b border-base-content/10"
  >
    <div class="store-page__container text-xl text-start font-semibold">สินค้ามาใหม่</div>
