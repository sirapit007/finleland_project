<template>
        ...
        <div class="flex-1 space-y-6">
          ...
          <div v-if="user" class="flex gap-2 items-center justify-between">
            <div class="min-w-0">
              ...
              <p
                v-if="hasDiscount"
                class="text-sm text-base-content/45 line-through"
              >
  ...
  >
    <div
      class="mx-auto w-full max-w-7xl px-0 sm:px-6 lg:px-8 text-xl text-start font-semibold"
    >
      หมวดหมู่ที่เกี่ยวข้อง
    </div>

    <div
      class="mx-auto w-full max-w-7xl px-0 sm:px-6 lg:px-8 relative overflow-hidden"
    >
