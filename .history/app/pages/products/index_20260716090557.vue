<template>
  <div class="flex justify-center px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-4xl space-y-3 py-7 text-center sm:space-y-4 sm:py-10 lg:py-12">
      <div class="text-3xl font-bold text-primary sm:text-4xl lg:text-5xl">
      ...
      <div>
        <label class="input input-xs w-full shadow-sm sm:input-sm sm:w-auto">
  ...
  <div class="w-full bg-base-100">
    <div class="mx-auto w-full max-w-7xl px-0 py-4 sm:px-6 sm:py-8 lg:px-8">
      <div class="flex flex-col gap-5 p-4 sm:p-6 lg:flex-row lg:gap-4 lg:p-8">
        <div class="grid w-full grid-cols-2 gap-1 pt-2 sm:grid-cols-3 lg:block lg:w-50 lg:space-y-1">
          <div class="col-span-full text-xs sm:text-sm lg:text-base">หมวดหมู่สินค้า</div>
          <NuxtLink
            to="/products"
        ...
        <div class="min-w-0 flex-1">
          <div class="mb-3 flex flex-col gap-3 sm:mb-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div
            ...
            :class="[
              ...
              gridValue === 2 ? 'grid-cols-1 sm:grid-cols-2' : '',
              gridValue === 3
