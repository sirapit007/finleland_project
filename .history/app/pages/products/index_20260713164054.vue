<template>
  ...
  <div class="w-full bg-base-100">
    <div class="mx-auto w-full max-w-7xl px-0 py-6 sm:px-6 sm:py-8 lg:px-8 flex flex-rows">
      <div class="space-y-4 p-4 sm:p-6 lg:p-8">
        ...
        <div class="flex-1">
          <div class="flex justify-between items-center">
            ...
            <div
              class="flex-1 space-y-1 text-end sm:grid sm:grid-cols-3 sm:items-center sm:gap-4"
            >
              <div class="text-sm">
