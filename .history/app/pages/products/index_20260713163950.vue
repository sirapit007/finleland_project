<template>
  <div class="flex justify-center">
    <div class="max-w-4xl space-y-4 py-12 text-center">
  ...
  <div class="store-page flex justify-center">
    <div class="store-page__container flex flex-col gap-8 space-y-4 py-10 lg:flex-row">
      <div class="w-full space-y-1 lg:w-50">
      ...
      <div class="flex-1">
        <div class="flex justify-between items-center">
          ...
          <div class="flex-1 space-y-1 text-end sm:grid sm:grid-cols-3 sm:items-center sm:gap-4">
            <div class="text-sm">
        ...
        <div
          ...
          :class="[
            ...
            gridValue === 3 ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3' : '',
            gridValue === 4 ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-4' : '',
          ]"
        >
