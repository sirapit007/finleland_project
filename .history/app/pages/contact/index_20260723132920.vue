<template>
  ...
  <div class="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
    ...
    >
      ...
      <form class="space-y-4 flex flex-col" @submit.prevent="submitFeedback">
        <label class="form-control">
          ...
          <textarea
            v-model="message"
            class="textarea textarea-bordered sm:textarea-md textarea-sm min-h-44 w-full resize-y leading-7"
          ...
          <span class="label justify-end pt-2">
            <span class="label-text-alt text-base-content/50 sm:text-base text-xs">
        ...
        <button
          class="btn btn-primary sm:btn-md btn-sm  w-full sm:w-auto sm:min-w-36"
          type="submit"
          :disabled="!canSubmit"
        >
          <Icon
