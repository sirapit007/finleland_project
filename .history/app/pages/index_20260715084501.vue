<template>
  <div
    class="store-page flex min-h-screen flex-col items-center justify-center bg-base-200 bg-contain bg-center bg-no-repeat relative"
  >
    <div class="store-page__container max-w-4xl text-center space-y-3 py-20">
  ...
  <div class="w-full flex flex-col justify-center items-center mt-10">
    <div class="store-page__container space-y-3">
      ...
      <div class="tabs tabs-border">
        ...
        >
          ...
          <div class="tab-content p-0">
            <div class="my-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
  ...
  <div class="w-full flex flex-col justify-center items-center mt-10">
    <div
      class="store-page__container grid grid-cols-1 gap-8 space-y-3 rounded-xl border border-base-content/10 p-6 shadow-sm sm:grid-cols-2 sm:p-12"
    >
      <div>
