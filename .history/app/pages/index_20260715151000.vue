<template>
  <div class="overflow-x-hidden">
    <section class="bg-base-300">
      <div
        class="space-y-1 mx-auto w-full max-w-3xl px-4 py-14 text-center sm:px-6 sm:py-18 lg:px-8 lg:py-24"
      >
        ...
        <p
          class="mx-auto max-w-3xl text-sm font-medium leading-7 text-base-content/75 sm:text-base"
        >
          ฟินลี่แลนด์ พลาซ่า
    ...
    <section
      class="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8"
    >
      <div class="space-y-4">
