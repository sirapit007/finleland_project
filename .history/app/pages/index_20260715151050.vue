<template>
  <div class="overflow-x-hidden">
    <section class="bg-base-300">
      <div
        class="space-y-1.5 mx-auto w-full max-w-3xl px-4 py-14 text-center sm:px-6 sm:py-16 lg:px-8 lg:py-20"
      >
        ...
        <p
          class="mx-auto max-w-3xl text-sm font-medium leading-7 sm:text-base"
        >
          ฟินลี่แลนด์ พลาซ่า
