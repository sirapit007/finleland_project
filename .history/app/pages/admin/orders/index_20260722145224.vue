      ...
      >
        <thead class="text-xs">
          <tr>
            <th>Order</th>
            <th>Customer</th>
            <th class="sm:table-cell hidden">Delivery</th>
            <th class="text-center md:table-cell hidden">Items</th>
            <th class="md:table-cell hidden">Total</th>
            <th class="md:table-cell hidden">Payment</th>
            <th>Status</th>
            <th class="md:table-cell hidden">Completed</th>
            <th></th>
          </tr>
        </thead>
        <tbody>
          <template v-for="order in data?.rows || []" :key="order.uuid">
            <tr class="hover:bg-primary/5">
              ...
              <td class="sm:table-cell hidden">
                <p class="badge badge-sm font-semibold bg-base-100 flex items-start gap-1">
                  <Icon
...
const historyStepMap: Record<string, string> = {
...
const historyStepClass = (history: Row) =>
  historyStepMap[String(history.order_status_history_status || "")] ||
  "step-neutral";
