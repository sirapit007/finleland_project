      ...
      >
        <thead class="text-xs">
          <tr>
            <th>Order</th>
            <th>Customer</th>
            <th class="sm:flex hidden">Delivery</th>
            <th class="text-center md:flex hidden">Items</th>
            <th class="md:flex hidden">Total</th>
            <th class="md:flex hidden">Payment</th>
            <th>Status</th>
            <th class="md:flex hidden">Completed</th>
            <th></th>
          </tr>
        </thead>
        <tbody>
          <template v-for="order in data?.rows || []" :key="order.uuid">
            <tr class="hover:bg-primary/5">
              ...
              <td class="text-center md:flex hidden">{{ order.order_item_count || 0 }}</td>
              <td class="font-bold text-primary md:flex hidden">
                ฿{{ formatMoney(order.order_grand_total) }}
              </td>
              <td class="md:flex hidden">
                <span
