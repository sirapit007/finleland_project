<template>
  ...
  <div class="bg-base-100 p-4">
    ...
    <div
      class="relative my-0 min-h-[calc(100dvh-15rem)] max-h-[calc(100dvh-15rem)] overflow-auto rounded-2xl border border-base-300 bg-base-100 shadow-sm sm:my-2 md:my-4"
