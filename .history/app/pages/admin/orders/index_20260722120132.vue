      ...
      >
        <thead class="text-xs">
          <tr>
            <th>Order</th>
            <th>Customer</th>
            <th class="sm:normal hidden">Delivery</th>
            <th class="text-center md:normal hidden">Items</th>
            <th class="md:normal hidden">Total</th>
            <th class="md:normal hidden">Payment</th>
            <th>Status</th>
            <th class="md:normal hidden">Completed</th>
            <th></th>
          </tr>
        </thead>
        <tbody>
          <template v-for="order in data?.rows || []" :key="order.uuid">
            <tr class="hover:bg-primary/5">
              ...
              <td class="text-center md:normal hidden">{{ order.order_item_count || 0 }}</td>
              <td class="font-bold text-primary md:normal hidden">
                ฿{{ formatMoney(order.order_grand_total) }}
              </td>
              <td class="md:normal hidden">
                <span
