<template>
  ...
  <div class="bg-base-100 p-4">
    ...
    <div
      class="relative md:min-h-[calc(100dvh-16rem)] md:max-h-[calc(100dvh-16rem)] min-h-[calc(100dvh-16.5rem)] max-h-[calc(100dvh-16.5rem)] 
      overflow-auto rounded-2xl border border-base-300 bg-base-100 shadow-sm sm:my-2 md:my-4 my-1"
