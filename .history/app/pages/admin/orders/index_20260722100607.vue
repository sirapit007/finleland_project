<template>
  ...
  <div class="bg-base-100 p-4">
    ...
    <div
      class="relative my-1 min-h-[calc(100dvh-16rem)] max-h-[calc(100dvh-16rem)] 
      overflow-auto rounded-2xl border border-base-300 bg-base-100 shadow-sm sm:my-2 md:my-4"
    ...
    >
      ...
      <table class="table min-w-max table-zebra bg-base-100 text-xs table-pin-rows sm:table-sm">
        <thead class="text-xs">
          <tr>
            <th>Order</th>
            <th>Customer</th>
                          ...
                          >
                            ...
                            <td>
                              <div class="join">
                                ...
                                ><button
                                  class="btn btn-xs join-item"
                                  :disabled="
                                    isTerminal(order) || isActionLoading
                                  "
                                  @click="changeQuantity(order, item, 1)"
                                >
                            ...
                            <td class="text-right">
                              <button
                                ...
                                :disabled="isTerminal(order) || isActionLoading"
