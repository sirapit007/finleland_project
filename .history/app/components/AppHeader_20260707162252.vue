      ...
      <div class="navbar-start w-[80%] flex justify-between">
        ...
        <div class="space-x-5 flex">
          ...
          <NuxtLink
            ...
            :class="
              route.path === '/shopping-basket' ? 'text-primary font-semibold' : ''
            "
            ><Icon name="lucide:shopping-cart" size="16" /> ตะกร้าสินค้า <span class="badge badge-info badge-sm rounded-full text-xs">0</span></NuxtLink
          >
        </div>
      </div>
    </div>
