    ...
    <NuxtLink class="h-full" :to="`/products/${props.object.product_name}`">
      <div class="card-body p-0 pb-6 relative">
        <img
          ...
          class="rounded-t-2xl bg-base-100 border border-base-300 min-h-[150px] max-h-[150px] object-contain"
        />
        <img
          v-else
          src="@/assets/images/blank.png"
          class="rounded-t-2xl bg-base-100 border border-base-300 max-h-[150px] max-h-[150px] object-contain"
        />
