<template>
  ...
  >
    ...
    >
      <div class="mx-8 grid grid-cols-1 gap-4 sm:mx-12 sm:grid-cols-3 lg:grid-cols-4">
  ...
  <button
    @click="prevSlide"
    class="btn btn-circle btn-sm btn-ghost absolute left-0 top-1/2 -translate-y-1/2 sm:btn-lg"
  >
    ❮
  </button>
  ...
  <button
    @click="nextSlide"
    class="btn btn-circle btn-sm btn-ghost absolute right-0 top-1/2 -translate-y-1/2 sm:btn-lg"
  >
    ❯
  </button>
