<template>
  ...
  <header class="shrink-0 border-b border-base-300 bg-base-100">
    ...
    >
      ...
      <nav class="sm:flex hidden items-center gap-5" aria-label="เมนูหลัก">
        <NuxtLink
          v-for="menu in menus"
          :key="menu.path"
          :to="menu.path"
  ...
  <div class="fab fab-flower">
    ...
    <button class="fab-main-action btn btn-circle btn-lg shadow">
      <Icon name="lucide:x" size="20" />
    </button>
    <div v-for="menu in menus" class="tooltip tooltip-left" :data-tip="menu.title">
      <NuxtLink
        :key="`fab-${menu.path}`"
        :to="menu.path"
