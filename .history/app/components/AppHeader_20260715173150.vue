<template>
  ...
  <header class="shrink-0 border-b border-base-300 bg-base-100">
    <div
      class="sm:block hidden overflow-hidden bg-primary transition-[max-height,opacity,transform] duration-300 ease-out"
      :class="
        isTopBarVisible
    ...
    >
      ...
      <nav class="hidden items-center gap-5 sm:flex" aria-label="เมนูหลัก">
        <NuxtLink
          v-for="menu in menus"
          :key="menu.path"
          :to="menu.path"
      ...
      >
        ...
        >
          ...
          <div class="min-w-0 text-left">
            <p class="max-w-24 truncate text-หท font-semibold sm:max-w-36">
  ...
  <div class="fab fixed bottom-5 right-5 z-50 sm:hidden">
    <div
      tabindex="0"
      role="button"
