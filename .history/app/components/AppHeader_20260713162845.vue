  ...
  <header>
    <div class="bg-primary h-8 flex justify-center">
      <div class="navbar-start w-[80%] flex justify-between">
        ...
        <div
          class="w-full text-xs text-primary-content font-semibold space-x-4 flex justify-end items-center"
          v-if="isLoggedIn"
        >
          ...
          <button class="btn btn-xs btn-ghost text-error text-xs" @click="onSignOut">
