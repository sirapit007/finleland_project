<template>
  ...
  <header class="shrink-0 border-b border-base-300 bg-base-100">
    <div
      class="dm:block hidden overflow-hidden bg-primary transition-[max-height,opacity,transform] duration-300 ease-out"
      :class="
        isTopBarVisible
  ...
  <div class="fab fixed bottom-5 right-5 z-50 md:hidden">
    <div
      tabindex="0"
      role="button"
