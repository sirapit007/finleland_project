<template>
  ...
  <header>
      ...
      <div class="navbar-start w-[80%] flex justify-between">
        ...
        >
          <div class="dropdown dropdown-end relative z-10">
            ...
            >
              <li>
                <NuxtLink class="text-xs hover:text-primary" to="/profile">
    ...
    >
      <div class="navbar-start w-[77.5%] flex justify-between">
        <NuxtLink to="/">
        ...
        <div class="space-x-5 flex">
          ...
          <NuxtLink
            ...
            to="/profile"
            class="text-sm hover:text-primary flex items-center gap-1"
            :class="route.path === '/profile' ? 'text-primary font-semibold' : ''"
          >
