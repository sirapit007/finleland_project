      ...
      <div class="w-[80%] grid grid-cols-5 gap-8 py-16">
        <div class="space-y-3 text-sm text-base-content/75">
          ...
          <div class="flex flex-col space-y-2">
            <div class="flex items-center gap-2 hover:underline" v-for="menu in menus">
        ...
        <div class="space-y-4 text-sm text-base-content/75">
          ...
          <div class="flex items-center gap-2 cursor-pointer hover:underline" v-on:click="openFacebook">
            <Icon name="ri:facebook-fill" size="16" /> ฟินลี่แลนด์ พลาซ่า
            เวียงสา
          </div>
          <div class="flex items-center gap-2 cursor-pointer hover:underline" v-on:click="openTiktok">
