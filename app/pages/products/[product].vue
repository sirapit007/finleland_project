<template>
  ...
  <div
    v-else
    class="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-12"
  >
    <div class="h-full flex flex-col gap-6 lg:flex-row lg:gap-8">
      <div
        v-if="selectedProductImage"
        class="flex h-full w-full flex-1 flex-col items-center gap-3 lg:items-end"
      >
        <img
          :src="selectedProductImage"
          class="h-60 sm:h-80 lg:h-full max-w-full rounded-lg border border-base-300 object-contain"
        />
        <div
      ...
      <div class="min-w-0 flex-1 space-y-4 sm:space-y-5 lg:space-y-6">
        ...
        <div
          v-else
          class="text-sm font-semibold text-primary sm:text-base lg:text-lg cursor-pointer"
          @click="onSignIn"
        >
        ...
        <div class="text-sm lg:text-base">
          ...
          <p
            v-if="base.object.product_description"
            class="mt-1 whitespace-pre-line text-base-content/80"
          >
            {{ base.object.product_description }}
          </p>
        </div>
      </div>
    </div>
  ...
  <div
    class="w-full flex flex-col justify-center items-center pt-5 pb-3 border-t border-base-content/10"
  >
    <div
