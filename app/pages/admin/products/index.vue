              ...
              >
                ...
                <td class="text-end">
                  ...
                  <button
                    ...
                    v-on:click="fnDetail.onRemove(row)"
                  >
                    ลบ
                  </button>
                </td>
        ...
        <tbody>
          ...
          >
            ...
            <td>
              ...
              <div
                v-else
                class="h-12 w-12 cursor-not-allowed"
              >
                <img src="@/assets/images/blank.png" class="h-full w-full object-cover" />
              </div>
            </td>
...
const fnBase = {
  ...
  onRemove: async (row: any) => {
    remove.value.path = "/api/products";
